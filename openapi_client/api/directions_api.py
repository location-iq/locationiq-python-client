...
class DirectionsApi(object):
    ...
    def directions(self, coordinates, **kwargs):  # noqa: E501
        """Directions Service  # noqa: E501

        Finds the fastest route between coordinates in the supplied order.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.directions(coordinates, async_req=True)
        >>> result = thread.get()
        ...
        :param float alternatives: Search for alternative routes. Passing a number alternatives=n searches for up to n alternative routes. [ true, false (default), or Number ]
        ...
        :param str continue_straight: Forces the route to keep going straight at waypoints constraining uturns there even if it would be faster. Default value depends on the profile [ default (default), true, false ]
        ...
        return self.directions_with_http_info(coordinates, **kwargs)  # noqa: E501

    def directions_with_http_info(self, coordinates, **kwargs):  # noqa: E501
        """Directions Service  # noqa: E501

        Finds the fastest route between coordinates in the supplied order.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.directions_with_http_info(coordinates, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(DirectionsDirections, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        all_params = ['coordinates', 'bearings', 'radiuses', 'generate_hints', 'approaches', 'exclude', 'alternatives', 'steps', 'annotations', 'geometries', 'overview', 'continue_straight']  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('coordinates' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `coordinates` when calling `directions`")  # noqa: E501
        ...
        if 'alternatives' in local_var_params and local_var_params['alternatives'] is not None:  # noqa: E501
        ...
        if 'continue_straight' in local_var_params and local_var_params['continue_straight'] is not None:  # noqa: E501
        ...
        return self.api_client.call_api(
            '/directions/driving/{coordinates}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='DirectionsDirections',  # noqa: E501
